...
const char* ssid = "Flia Rodriguez";                        //SSID del router.
const char* password = "Elacabado494";                //Contraseña del router.

unsigned long channelID = 2711679;                //ID del canal.
const char* WriteAPIKey = "B9GM8PYTMPYP2DHT";     //Write API Key del canal.
